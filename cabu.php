...
if(NULL != $r){
	...
	header("Location: ".WEB_URL."login.php?error=username&requested=" . urlencode($_SERVER["REQUEST_URI"]));
	exit;
...
$headline=sprintf("CABU %s<br />Current Conditions",$serial_id);
...
<div id="wrapper">
	...
	<span>Hover the mouse over the minimum and maximum values to see what time they occurred.</span>
	<table style="border:none; width:90%">
		...
		<tr >
			...
			<td class="cabutable" id="batt_charge_cabu"></td>
		...
		<tr>
			...
			<td class="cabutable" id="batt_veh_charge_cabu"></td>
		...
		<tr>
			...
			<td class="cabutable" id="charger"> <span id="charger_current" class="emph">...</span><br>amps</td>
		...
		<tr>
			...
			<td class="cabutable" id="load"> <span id="load_current" class="emph">...</span><br>amps</td>
		...
		<tr>
			...
			<td class="cabutable" id="extTemp"> <span id="external_temp" class="emph">...</span></td>
		...
		<tr>
			...
			<td class="cabutable" id="intTemp"> <span id="internal_temp" class="emph">...</span></td>
...
<?}?>	
	<button id="button1" name="unitTog" onclick="toggleUnit()">Change Temperature unit</button>
	<br><br>
